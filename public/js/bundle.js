...
var login = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(email, password) {
    var res, _res$data, cookieOptions, token;
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              _res$data = res.data, cookieOptions = _res$data.cookieOptions, token = _res$data.token; // document.cookie = `jwt=${token}`;
...
var stript = Stripe("pk_test_51KsOXMSCrXTMrsPh538hllEIbM9vkCIfrBOY21T6HeapnfTJktXGgWnq5Au6TJdbxrQq3MOEqcAnTx8y2p1GrYSl00m5fmNKAD");
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return (0, _axios.default)("localhost:3000/api/v1/bookings/checkout-session/".concat(tourId));
